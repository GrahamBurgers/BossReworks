...
local function modify_wand(entity_id, projectile_file, delay_frames, sprite_file, lifetime, air_friction,
						   shot_speed_multiplier, add_delay)
	local x2, y2 = EntityGetTransform(entity_id)
	EntityLoad("data/entities/particles/poof_blue.xml", x2, y2)
	local var = EntityGetFirstComponent(entity_id, "VariableStorageComponent") or 0 ---@cast var component_id
	...
	if lifetime then
		local proj = EntityGetFirstComponent(entity_id, "ProjectileComponent") or 0 ---@cast proj component_id
		ComponentSetValue2(proj, "lifetime", lifetime)
	end
	if air_friction then
		local vel = EntityGetFirstComponent(entity_id, "VelocityComponent") or 0 ---@cast vel component_id
...
local function spheres()
	...
	local wand1 = ShootProjectile(me, "mods/boss_reworks/files/boss_pit/wand.xml", x, y, math.cos(theta1),
		math.sin(theta1), 0.9)
	local wand2 = ShootProjectile(me, "mods/boss_reworks/files/boss_pit/wand.xml", x, y, math.cos(theta2),
		math.sin(theta2), 0.9)
	modify_wand(wand1, "data/entities/projectiles/orb_expanding.xml", 35, "data/items_gfx/wands/wand_0320.png", 200, 0.3,
		1.5)
	modify_wand(wand2, "data/entities/projectiles/orb_expanding.xml", 35, "data/items_gfx/wands/wand_0320.png", 200, 0.3,
		1.5)
end
...
local function chaingun()
	...
	local wand = ShootProjectile(me, "mods/boss_reworks/files/boss_pit/wand.xml", x, y, math.cos(theta), math.sin(theta),
		7)
	modify_wand(wand, "data/entities/projectiles/deck/machinegun_bullet.xml", 3,
		"data/items_gfx/wands/custom/actual_wand.xml", 100, 7, 1)
end
...
local function bb()
	...
	local wand = ShootProjectile(me, "mods/boss_reworks/files/boss_pit/wand.xml", x, y, math.cos(theta), math.sin(theta),
		2)
	modify_wand(wand, "data/entities/projectiles/deck/rubber_ball.xml", 40, "data/entities/animals/boss_pit/wand_07.png",
		180, 4, 0.4)
end

local function thundercharge()
	local wand = ShootProjectile(me, "mods/boss_reworks/files/boss_pit/wand.xml", x, y, 0, 20, 1)
	modify_wand(wand, "data/entities/projectiles/thunderball.xml", 60, "data/items_gfx/wands/wand_0521.png", 200, 0.6,
		0.8)
end
...
local function gigasaws()
	...
	local wand = ShootProjectile(me, "mods/boss_reworks/files/boss_pit/wand.xml", x, y, math.cos(theta), math.sin(theta),
		0.8)
	modify_wand(wand, "data/entities/projectiles/deck/disc_bullet_big.xml", 100, "data/items_gfx/wands/wand_0141.png",
		300, 0, 0.5)
end
...
local function effectorbs()
	...
	local wand1 = ShootProjectile(me, "mods/boss_reworks/files/boss_pit/wand.xml", x, y, math.cos(theta2),
		math.sin(theta2), -2)
	modify_wand(wand1, "mods/boss_reworks/files/boss_wizard/effect_orb.xml", 1, "data/items_gfx/wands/wand_0447.png", 55,
		3, 0.4)
	local wand2 = ShootProjectile(me, "mods/boss_reworks/files/boss_pit/wand.xml", x, y, math.cos(theta1),
		math.sin(theta1), -1)
	modify_wand(wand2, "mods/boss_reworks/files/boss_wizard/effect_orb.xml", 10, "data/items_gfx/wands/wand_0447.png",
		120, 1, 0.4)
end
...
local function missile()
	...
	local wand = ShootProjectile(me, "mods/boss_reworks/files/boss_pit/wand.xml", x, y, math.cos(theta), math.sin(theta),
		2)
	modify_wand(wand, "data/entities/projectiles/deck/rocket_tier_2.xml", 40,
		"data/entities/animals/boss_pit/wand_08.png", 180, 4, 1.1)
end
